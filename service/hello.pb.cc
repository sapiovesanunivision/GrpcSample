...
const char descriptor_table_protodef_hello_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "message\030\001 \001(\t\"\035\n\nHelloReply\022\017\n\007message\030\001"
    " \001(\t2K\n\014HelloService\022;\n\017GetHelloMessage\022"
    "\023.hello.HelloRequest\032\021.hello.HelloReply\""
    "\000b\006proto3"
};
        ...
        ::uint8_t* HelloRequest::_InternalSerialize(
          ...
          if (!this_._internal_message().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "hello.HelloRequest.message");
